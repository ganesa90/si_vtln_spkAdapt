...
% Suppose Mathworks removes textread from future versions of Matlab, use
% this code by adding customTools to the path
...
%   $Revision: 1.16.4.11 $ $Date: 2011/09/03 22:42:57 $
