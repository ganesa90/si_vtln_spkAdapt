...
if isempty(PP)
    ...
    PP.dir_temp='C:\Documents and Settings\ganesa90\temp';  % directory for storing temporary files
    PP.dir_data='C:\Documents and Settings\ganesa90\My Documents\Research\speech';  % default directory to preappend to speech data file names
    PP.shorten='C:\bin\shorten.exe';            % location of shorten executable
    PP.flac='C:\Documents and Settings\ganesa90\My Documents\Research\SpeechSoftwares\voicebox\flac.exe';   % location of flac executable
